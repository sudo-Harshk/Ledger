...
interface MousePositionShape { x: number; y: number }

function useMousePosition(): MousePositionShape {
  const [mousePosition, setMousePosition] = useState<MousePositionShape>({ x: 0, y: 0 })
  useEffect(() => {
...
export const Particles: React.FC<ParticlesProps> = ({
  ...
  const clearContext = () => { context.current?.clearRect(0, 0, canvasSize.current.w, canvasSize.current.h) }
