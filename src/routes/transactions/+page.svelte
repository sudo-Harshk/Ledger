...
<div class="px-4 pt-6 md:px-8 md:pt-8 animate-fade-in">
  <!-- Desktop: two-column (controls left, list right). Mobile: single column. -->
  <div class="md:grid md:grid-cols-[300px_1fr] md:gap-6 md:items-start">

    <!-- Left column: header + month nav + summary stats -->
    <div>
